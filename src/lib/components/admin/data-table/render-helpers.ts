...
export function headerComponent(text: string, context: HeaderContext<any, unknown>) {
	return renderComponent(TableHeaderCell, {
		text: text,
		sortable: context.column.getCanSort(),
		toggleSort: context.column.getToggleSortingHandler()
	});
}
